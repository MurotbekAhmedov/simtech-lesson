...
{include file="views/profiles/components/users_search_form.tpl" dispatch="profiles.picker-s" extra="<input type=\"hidden\" name=\"result_ids\" value=\"pagination_`$smarty.request.data_id|escape:'html'`\">" put_request_vars=true form_meta="cm-ajax" in_popup=true}
